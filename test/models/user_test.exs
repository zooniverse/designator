defmodule Designator.UserTest do
  ...
  describe "configuration" do
    test "returns the per-workflow user configuration" do
      ...
      Ecto.Adapters.SQL.query!(Designator.Repo, "INSERT INTO user_project_preferences (user_id, project_id, settings, created_at, updated_at) VALUES (3, 2, '{\"designator\": {\"1\": {\"subject_set_chances\": {}}}}'::jsonb, NOW(), NOW())")
    ...
    test "when user_project_preference is not configured for designator" do
      Ecto.Adapters.SQL.query!(Designator.Repo, "INSERT INTO workflows (id, project_id, created_at, updated_at) VALUES (1, 2, NOW(), NOW())")
      Ecto.Adapters.SQL.query!(Designator.Repo, "INSERT INTO user_project_preferences (user_id, project_id, settings, created_at, updated_at) VALUES (3, 2, '{\"asdf\": 1}'::jsonb, NOW(), NOW())")
    ...
    test "when user_project_preference does not have designator configuration for this workflow" do
      Ecto.Adapters.SQL.query!(Designator.Repo, "INSERT INTO workflows (id, project_id, created_at, updated_at) VALUES (1, 2, NOW(), NOW())")
      Ecto.Adapters.SQL.query!(Designator.Repo, "INSERT INTO user_project_preferences (user_id, project_id, settings, created_at, updated_at) VALUES (3, 2, '{\"designator\": {\"9000\": {\"subject_set_chances\": {}}}}'::jsonb, NOW(), NOW())")
