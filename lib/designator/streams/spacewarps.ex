defmodule Designator.Streams.Spacewarps do
  ...
  def apply_weights(streams, workflow, user) do
    ...
    training_set_ids = workflow.configuration["spacewarps_training_sets"] || []
  ...
  def training_chance(n) when n in 16..40, do: 0.20
  def training_chance(_),                  do: 0.1
end
